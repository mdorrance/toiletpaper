...
class CabinsControllerTest < ActionController::TestCase
  ...
  test "should create cabin" do
    assert_difference('Cabin.count') do
      post :create, cabin: { address: @cabin.address, emergency: @cabin.emergency, family_id: @cabin.family_id, name: @cabin.name }
    end
  ...
  test "should update cabin" do
    put :update, id: @cabin, cabin: { address: @cabin.address, emergency: @cabin.emergency, family_id: @cabin.family_id, name: @cabin.name }
    assert_redirected_to cabin_path(assigns(:cabin))
  end
