...
class ToDoListsControllerTest < ActionController::TestCase
  ...
  test "should create to_do_list" do
    assert_difference('ToDoList.count') do
      post :create, to_do_list: { completed_date: @to_do_list.completed_date, created_by: @to_do_list.created_by, due_date: @to_do_list.due_date, family_id: @to_do_list.family_id, note: @to_do_list.note, task: @to_do_list.task }
    end
  ...
  test "should update to_do_list" do
    put :update, id: @to_do_list, to_do_list: { completed_date: @to_do_list.completed_date, created_by: @to_do_list.created_by, due_date: @to_do_list.due_date, family_id: @to_do_list.family_id, note: @to_do_list.note, task: @to_do_list.task }
    assert_redirected_to to_do_list_path(assigns(:to_do_list))
  end
